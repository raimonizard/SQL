...
BEGIN
    ...
    -- Fem una crida a la funció estàtica que permet executar un algoritme sense necessitat de crear un objecte de la classe Bici
    resultatSuma := Bici.sumaValors(2, 4);
    
    DBMS_OUTPUT.PUT_LINE('El resultat de la suma és: ' || resultatSuma);
